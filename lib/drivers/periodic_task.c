...
void periodic_task_init_a(void (*user_function_a)(), uint32_t interval_ms_a) {
...
void periodic_task_init_b(void (*user_function_b)(), uint32_t interval_ms_b) {
  user_func_b = user_function_b;
  init_timer3();

  //(interval_ms_a*125)>>19;
  cnt_b = (interval_ms_b/1000*(F_CPU/1024))/0xFFFF;
  loops_b = cnt_b;
...
void periodic_task_init_c(void (*user_function_c)(), uint32_t interval_ms_c) {
  user_func_c = user_function_c;
  init_timer3();

  //(interval_ms_a*125)>>19;
  cnt_c = (interval_ms_c/1000*(F_CPU/1024))/0xFFFF;
  loops_c = cnt_c;
